...
urlpatterns = [
    ...
    url(r'^accounts/login',register,name='loginto'),
    ...
    url(r'^detailbuy/(?P<page_num>\d+)$', detailbuy, name='detailbuy'),
    url(r'^buy/(?P<page_num>\d+)$', buy, name='buy'),
    url(r'^message/',display_message,name='message')
